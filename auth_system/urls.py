...
from .views import HomePage, Register, Login, Logout, profile, update_profile_picture, display_favorites, remove_favorite, clear_favorites, save_to_favorites, remove_saved_favorite, get_product_count
